...
class GeometryDashAI:
    ...
    def __init__(self, state_size=4, action_size=2, load_model=True):
        ...
        # Compteur pour sauvegarde périodique
        ...
        def replay(self, batch_size=32):
            """
            Rejoue les expériences pour l'apprentissage et sauvegarde périodiquement
            """
        ...
        # Sauvegarde périodique tous les 100 appels à replay
        self.replay_call_count += 1
        if self.replay_call_count % 100 == 0:
            self.save_model()
    ...
    for e in range(episodes):
        ...
        while running:
            ...
            if not player.is_alive:
                ...
                reward += 0.01  # Récompense pour chaque frame survivante
