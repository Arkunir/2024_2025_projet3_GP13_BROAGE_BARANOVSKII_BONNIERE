    ...
    for episode in range(EPISODES):
        ...
        while not done:
            ...
            if can_spawn_obstacle and current_time - last_object > object_interval:
                ...
                # Choisir l'obstacle en fonction de la vitesse actuelle
                obj = None
            ...
            # Mise à jour des objets du jeu et vérification des collisions
            for obj in game_objects[:]:
                obj.update()
                
                # Gestion des collisions pour les différents types d'obstacles
                if isinstance(obj, Obstacle) and player.rect.colliderect(obj.get_rect()):
                    player.is_alive = False
                    done = True
                    break
                
                # Gestion de JumppadOrbsObstacle
                ...
                # Gestion de FivePikesWithOrb
                elif isinstance(obj, FivePikesWithOrb):
                    obj.check_activation(player, pygame.key.get_pressed())
                ...
                # Gestion de PurpleOrb
                elif isinstance(obj, PurpleOrb):
                    obj.check_activation(player, pygame.key.get_pressed())
                
                # Gestion de DoublePikes, TriplePikes et QuadruplePikes
                ...
                # Gestion de QuintuplePikesWithJumpPad
